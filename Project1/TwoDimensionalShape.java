...
/**
 * Class to handle the TwoDimensionalShape related methods and extend the shape class
 */
public class TwoDimensionalShape extends Shape {
    ...
    /**
     * To calculate the area of the three dimensional shape. It will override by
     * the child classes
     */
